...
addPropertyControls(Slider, {
  fillColor: { title: "Tint", type: ControlType.Color },
  trackColor: { title: "Track", type: ControlType.Color },
  knobColor: { title: "Knob", type: ControlType.Color },
  shadow: { type: ControlType.Color, title: "Shadow" }, // focusColor: {
  //     title: "Focus",
  ...
  trackHeight: { title: "Height", type: ControlType.Number, min: 0 },
  min: { title: "Min", type: ControlType.Number, displayStepper: true },
  trackRadius: {
    type: ControlType.Number,
    displayStepper: true,
    min: 0,
  ...
  max: { title: "Max", type: ControlType.Number, displayStepper: true },
